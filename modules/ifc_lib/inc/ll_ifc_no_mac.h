 ...
 *   number of bytes received
 *
 * @param[in] bool freq_error_requested
 *   If True, a Rx freq error will be returned on any received packet.
 *
 * @note
 ...
 *   If freq_error_requested is true, the following 4 bytes are the int32_t Rx freq error
