...
{
    uint32_t swo_prescaler, swo_speed;
    uint32_t sys_clock;

    swo_speed = 750000;
    sys_clock = CMU_ClockFreqGet(cmuClock_CORE);;
    swo_prescaler = (sys_clock / swo_speed) - 1;
    ...
    /* Configure the DEBUG CLK to HFCLK */
    CMU->CTRL |= CMU_CTRL_DBGCLK;
